...
function afterSubmit_onSave(type) {
	...
	var asnlineid = rec.getLineItemValue('recmachcustrecord_ts_created_fm_asn','id',1);
    var blanketPO = nlapiLookupField('customrecord_ts_asn_item_details', asnlineid, 'custrecord_ts_asn_bpo_line_no');
